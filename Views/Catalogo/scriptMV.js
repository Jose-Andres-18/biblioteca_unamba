document.addEventListener('DOMContentLoaded', () => {
    ...
    const books = [
        { title: "Programación Orientada a Objetos", author: "Autor A", image: "images/oop.jpg", copies: "Cantidad: "+10,isbn: "ISBN: 978-84-933117-5-4" },
    ...
    const medicinaButton = document.querySelector('a.btn-5'); // Selector modificado
    const booksSection = document.getElementById('booksSection');
    const bookList = document.getElementById('bookList');
    const searchInput = document.getElementById('searchInput');

    // Mostrar libros al hacer clic en el botón "Ingeniería Agroindustrial"
    medicinaButton.addEventListener('click', (e) => {
